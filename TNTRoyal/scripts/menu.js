...
const menu_setting = new ui.ModalFormData()
  .title("ゲーム設定")
  .slider("§l§e制限時間", 70, 300, 10, mc.world.getDynamicProperty("time"));
...
const world_description_home = new ui.ActionFormData()
  .title("§l§cTNT Royale")
...
const world_description_form = new ui.ActionFormData()
...
const world_precautions_form = new ui.ActionFormData()
...
const world_how_to_use_lobby_form = new ui.ActionFormData()
...
const rule_form = new ui.ActionFormData()
...
const operation_form = new ui.ActionFormData()
...
const item_description_form = new ui.ActionFormData()
